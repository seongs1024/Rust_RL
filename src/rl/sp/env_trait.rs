...
pub type State<E> = <<E as Environment>::StateSpace as Space>::Value;
pub type Action<E> = <<E as Environment>::ActionSpace as Space>::Value;
...
pub trait Environment {
    ...
    fn take_action(&mut self, action: Option<&Action<Self>>) -> bool;
